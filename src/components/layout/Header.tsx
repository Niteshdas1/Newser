...
+            <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-slate-900 to-slate-700 dark:from-slate-100 dark:to-slate-300 rounded-xl mr-4">
+              <Newspaper className="w-7 h-7 text-white dark:text-slate-900" />
             </div>
             <div>
...
+              <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Global News Hub</h1>
+              <p className="text-sm text-slate-600 dark:text-slate-300 mt-0.5">Your trusted source for breaking news</p>
             </div>
           </div>
@@ .. @@
         {/* Category Navigation */}
-        <nav aria-label="News categories" className="border-t border-slate-100 dark:border-slate-700 semi-dark:border-slate-600 py-4">
+        <nav aria-label="News categories" className="border-t border-slate-100 dark:border-slate-700 py-4">
